...
function GetNextPromotion(sPromotion)
  ...
  local sQuery = "SELECT p2.Type FROM UnitPromotions p1, UnitPromotions p2 WHERE p1.Type = ? AND (" .. sPrereqs .. ") AND p2.Type LIKE ?"
...
function GetDependantPromotions(sCombatClass, sPromotion)
  local promotions = {}
