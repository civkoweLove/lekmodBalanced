...
function( playerID, cityID, x, y, isWithGold, isWithFaithOrCulture, isHideNotification )
	...
	if isWithFaithOrCulture and playerID == g_activePlayerID then
		...
		if not isHideNotification and (plot and city and ( ( plot:GetWorkingCity() and not city:IsPuppet() ) or Game.GetResourceUsageType( plot:GetResourceType( g_activeTeamID ) ) > 0 ))
